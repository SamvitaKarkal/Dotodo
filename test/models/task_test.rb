...
class TaskTest < ActiveSupport::TestCase
  ...
  #   assert_instance_of Task, task      #Success as Task is a task

  #   assert_not_instance_of User, task    #User is not a Task
  # end

  # def test_value_of_title_assigned
  #   task = Task.new(title: "Title assigned for testing")

  #   assert_equal task.title == "Title assigned for testing", task.title
  # end
